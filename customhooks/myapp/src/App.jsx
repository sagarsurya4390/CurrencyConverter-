        ...
        <div className="w-full max-w-md mx-auto border border-gray-60 rounded-lg p-5 backdrop-blur-sm bg-white/30">
           <form onSubmit={(e) => {
            ...
            <div className="w-full mb-1">
              ...
              onCurrencyChange={(currecy)=>setAmount} selectedCurrency={from}
            ...
            <div className="relative w-full h-0.5">
              ...
              <div className="w-full mt-1 mb-4">
                ...
                onCurrencyChange={(currency)=>setTo(currency)} selectedCurrency={from}
                amountDisabled/>

              </div>
              <button type='sunmit' className="w-full bg-blue-600 text-white px-4 py-3 rounded-lg">
